...
cli-ck has full git integration backed by a dedicated Rust module. All git operations go through the workspace authorization registry, the same gate as PTY spawn and AI tool calls.
...
<img src="/cli-ck-website/source-control.webp" alt="Source control with commit graph" width="1200" />
