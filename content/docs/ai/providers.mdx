...
cli-ck is BYOK. No usage premium, no proxy, no lock-in. Cloud calls go directly from your machine to the provider through an SSRF-guarded Rust HTTP proxy (`ai_http_request`, `ai_http_stream`).
...
<img src="/cli-ck-website/model_selector.webp" alt="Model picker" width="900" />
