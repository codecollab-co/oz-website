...
When you open a new workspace directory, Oz prompts once to authorize it. The grant persists across sessions in the registry. An AI agent cannot read or write a sibling directory you have not explicitly opened.
