...
Oz ships as a signed desktop bundle. ProductDownload the installer for your platform from the [Releases](https://github.com/crynta/oz-ai/releases/latest) page. Oz auto-updates from there.

## macOS

Two separate `.dmg` builds - one for Apple Silicon (aarch64), one for Intel (x86_64). Pick the one that matches your hardware on the [Releases](https://github.com/crynta/oz-ai/releases/latest) page, drag Oz to `/Applications`, and launch.
